...
var routes = [
    ...
    { path: 'product/:id', component: _product_detail_product_detail_component__WEBPACK_IMPORTED_MODULE_3__["ProductDetailComponent"] },
];
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.updateProduct = function (product) {
        return this.http.patch(this.serverApi + "/product/" + product.id, product);
    };
...
module.exports = __webpack_require__(/*! /Users/richardmable/code/parbyWarker/src/main.ts */"./src/main.ts");
